    ...
    >
      ...
      <div className="relative z-10 w-full">
        ...
        <div 
          ...
          className="px-5 sm:px-8 lg:px-10 w-full overflow-hidden"
        >
          {/* ── Clean logo watermark (no text version) ── */}
          <img
            src="/Vinayak_Finserv_logo_clean.png"
            alt=""
            style={{
              position: 'absolute',
              top: '45%',
        ...
        >
          ...
          >
            ...
            <div style={{
              flex: 1,
              height: '2px',
              background: 'linear-gradient(90deg, transparent 0%, rgba(232,169,32,0.55) 100%)',
              borderRadius: '1px',
              minWidth: '24px',
              maxWidth: '100px',
            }} />
            ...
            <motion.h1
              ...
              style={{
                ...
                textShadow: '0 6px 48px rgba(0,0,0,0.5), 0 2px 16px rgba(0,0,0,0.3)',
                flexShrink: 0,
              }}
            >
              Vinayak{' '}
              <span
                style={{
                  color: '#E8A920',
                  textShadow: '0 0 80px rgba(232,169,32,0.45), 0 6px 40px rgba(0,0,0,0.35)',
                }}
              >
                Finserv
              </span>
            ...
            <div style={{
              flex: 1,
              height: '2px',
              background: 'linear-gradient(90deg, rgba(232,169,32,0.55) 0%, transparent 100%)',
              borderRadius: '1px',
              minWidth: '24px',
              maxWidth: '100px',
            }} />
        ...
        {/* ─── TWO COLUMN LAYOUT ─── */}
        <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-10 pb-16 lg:pb-20">
